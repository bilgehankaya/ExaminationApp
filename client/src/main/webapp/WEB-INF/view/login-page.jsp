                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="text-dark mb-4"><div class="sidebar-brand-icon rotate"><i class="fab fa-xing fa-2x"></i></div></h1>
                                    </div>
                                    
                                    <div class="text-center">
                                        <h4 class="text-dark mb-3">Register and Login.</h4>
                                    </div>

                                    <div class="text-center">
                                        <h4 class="text-dark mb-3">That's all!!</h4>
                                    </div>
									<form action="${pageContext.request.contextPath}/register/show">
										<div class="form-group text-center">
											<button class="btn btn-primary btn-block text-white btn-user" type="submit">Register Now!</button>
										</div>
									</form>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-4">Welcome to eeXam!</h4>
                                    </div>
                                    <form action="${pageContext.request.contextPath}/authenticateTheUser" method="POST" class="user">
